...
class FeeCategoryPolicy
{
    ...
    {
        return $user->can('view-any FeeCategory');
    }
    ...
    {
        return $user->can('view FeeCategory');
    }
    ...
    {
        return $user->can('create FeeCategory');
    }
    ...
    {
        return $user->can('update FeeCategory');
    }
    ...
    {
        return $user->can('delete FeeCategory');
    }
    ...
    {
        return $user->can('restore FeeCategory');
    }
    ...
    {
        return $user->can('force-delete FeeCategory');
    }
}
